<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<form class="form-horizontal" role="form" action="admin.php?page=wcbl-settings&settingsSave=on" method="post">
		<!-- General Settings -->
			<div class="row">
                <div class="col-lg-12">
					...
					<div class="form-group">
						<div class="col-sm-2">						
							...
							<ul class="dropdown-menu" role="menu">
								<li><a onclick="return confirm('Are you sure you want to empty all 404 log?');" href="<?php echo admin_url("admin.php?page=wcbl-settings&emptyLOG=on&emptyLOGStatu=404"); ?>"><?php _e('EMPTY 404 LOG', 'wblm') ?></a></li>
								<li><a onclick="return confirm('Are you sure you want to empty all 301 log?');" href="<?php echo admin_url("admin.php?page=wcbl-settings&emptyLOG=on&emptyLOGStatu=301"); ?>"><?php _e('EMPTY 301 LOG', 'wblm') ?></a></li>
								<li class="divider"></li>
								<li><a onclick="return confirm('Are you sure you want to empty all log?');" href="<?php echo admin_url("admin.php?page=wcbl-settings&emptyLOG=on"); ?>"><?php _e('EMPTY ALL LOG', 'wblm') ?></a></li>
							</ul>
							</div>
						</div>
						<div class="col-sm-2">
							<a onclick="return confirm('Are you sure you want to empty all broken URLs?');" href="<?php echo admin_url("admin.php?page=wcbl-settings&emptyBrokenUrls=on"); ?>">
		...
		<div class="panel panel-default">     
			...
			<div class="panel-body">                      
				...
				<div class="form-horizontal">
					<div class="form-group">
						<div class="col-sm-2">
							<a href="<?php echo admin_url("admin.php?page=wcbl-settings&exportUrls=on"); ?>">
