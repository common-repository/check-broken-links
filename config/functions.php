...
window.location="'. admin_url("admin.php?page=wcbl-settings"). '";
</script>';
}
...
function wpslAddURL(){
	...
	echo '<script type="text/javascript">
	window.location="'. admin_url("admin.php?page=wcbl-redirect") . '";
	</script>';
}
...
function wpslDelURL(){
	...
	if($page=='wcbl-broken' || $page=='wcbl-redirect'){
		echo '<script type="text/javascript">
...
function get_wblmTopNavi(){
	...
	printf($topNavi, admin_url("admin.php?page=wcbl-dashboard"), admin_url("admin.php?page=wcbl-redirect"), admin_url("admin.php?page=wcbl-broken"), admin_url("admin.php?page=wcbl-add-url"), admin_url("admin.php?page=wcbl-log"), admin_url("admin.php?page=wcbl-settings"));
}
function get_bulkEdit($page, $buttonText){
	...
	<div class="alert alert-info alert-dismissable" id="bulkEditBox">
		...
		$bulkEdit .= '<label>
				...
				<span><input type="text" class="wcbl-table-add-field" value="" name="new_url" placeholder="http://"></span>
			</label>
