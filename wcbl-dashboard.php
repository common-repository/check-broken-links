            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="<?php echo admin_url('admin.php?page=wcbl-broken'); ?>">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="<?php echo admin_url('admin.php?page=wcbl-redirect'); ?>">
                            <div class="panel-footer">
                                <span class="pull-left"><?php _e('View Details', 'wblm') ?></span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="<?php echo admin_url('admin.php?page=wcbl-log'); ?>">
                            <div class="panel-footer">
                                <span class="pull-left"><?php _e('View Details', 'wblm') ?></span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="<?php echo admin_url('admin.php?page=wcbl-dashboard'); ?>"> <?php _e('Yearly', 'wblm') ?> </a>
                                        </li>
                                        <li><a href="<?php echo admin_url('admin.php?page=wcbl-dashboard'); ?>"> <?php _e('Monthly', 'wblm') ?> </a>
                                        </li>
                                        <li><a href="<?php echo admin_url('admin.php?page=wcbl-dashboard'); ?>"> <?php _e('Daily', 'wblm') ?> </a>
                                        </li>
                                        <li class="divider"></li>
                                        <li><a href="<?php echo admin_url('admin.php?page=wcbl-dashboard'); ?>"> <?php _e('Default (Last 15 days)', 'wblm') ?> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
